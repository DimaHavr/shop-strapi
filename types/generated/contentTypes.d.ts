...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    personal_data: Attribute.String;
    delivery_data: Attribute.String;
    paymant_data: Attribute.String;
    order_subtotal: Attribute.String;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isNewProduct: Attribute.Boolean & Attribute.DefaultTo<false>;
...
export interface ApiSizeShoeSizeShoe extends Schema.CollectionType {
  collectionName: 'size_shoes';
  info: {
    singularName: 'size-shoe';
    pluralName: 'size-shoes';
    displayName: 'Size_Shoe';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    size_shoe: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::size-shoe.size-shoe',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::size-shoe.size-shoe': ApiSizeShoeSizeShoe;
